...
//     ms_node->next_node = ms->ms_list->head;
...
//     if(ms->height ==0){
//         printf("Pehle add to karlo kuch \n");
//         return NULL;
//     }
//     else{
//         MainStackNode* tem = ms->ms_list->head;
...
//     }
//     else{
//         AuxStackNode* tem = as->as_list->head;
...
//     for(int i =0; i<poppin; i++){
//         if(poppin - i > ms->height){
//             printf("Khatam stack \n");
//         }
//         temp = pop_ms(ms);
//     }
...
//     TreeNode * tn = ms->ms_list->head; // points to a treenode which is the top of the stack 
//     return tn;
...
//         TreeNode * tn;
// 		if(temp2->term_or_nonterm==0) {// if terminal 
